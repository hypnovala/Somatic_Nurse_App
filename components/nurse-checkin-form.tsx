  ...
  return (
    <div className="space-y-8">
      <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full border border-cyan-200/20 bg-cyan-300/10 px-4 py-2 text-xs uppercase tracking-[0.24em] text-cyan-50/90">
        ...
        >
          <p className="text-sm uppercase tracking-[0.24em] text-cyan-100/70">Current Check-In</p>
          <h2 className="mt-3 text-2xl font-semibold text-white">Notice what your body is signaling.</h2>
          ...
          <div className="mt-8 rounded-[24px] border border-white/10 bg-white/5 p-5">
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="text-sm text-slate-400">Average nervous system load</p>
                <p className="mt-2 text-3xl font-semibold text-white">{averageLabel}</p>
              </div>
              <div className="flex h-16 w-16 items-center justify-center rounded-full border border-cyan-200/20 bg-cyan-300/10 text-lg font-semibold text-cyan-50">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          <button
            type="submit"
            className="inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-cyan-300 via-teal-300 to-blue-400 px-6 py-3 text-sm font-semibold text-slate-950 transition hover:scale-[1.01]"
          >
            Generate My Reset
